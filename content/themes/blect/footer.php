    ...
    <footer id="colophon" class="site-footer dark" role="contentinfo">
        <div id="colophon-inner" class="container">
            <div class="row">
                ...
                <div class="col-sm-2">
                    <h4 class="margin-top-0">APPLE 101&deg;</h4>
                    <?php 
                    wp_nav_menu( array( 
                ...
                <div class="col-sm-4">
                    ...
                    ?>
                    <h4 class="margin-top-1x">电邮刊报</h4>
                    <?php get_template_part( 'partials/emmsubscribe' ); ?>
                </div>
            </div>            
        ...
        <div class="container">
            <div class="site-info">
                <?php echo date( 'Y' ) ?> &copy; APPLE 101&deg; SDN BHD. <a href="<?php echo home_url(); ?>"><?php bloginfo('name'); ?></a>
